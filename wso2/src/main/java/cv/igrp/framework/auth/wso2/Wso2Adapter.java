...
public abstract class Wso2Adapter implements IAdapter {
    ...
    @Override
    public void createApplication(String name, String departmentName) throws IAMException {
    ...
    @Override
    public void deleteApplication(String name, String departmentName) throws IAMException {
    ...
    @Override
    public void updateApplication(String name, String newName, String departmentName) throws IAMException {
    ...
    @Override
    public void createRole(String departmentName, String roleName) throws IAMException {
        log.info("Create Role with ApplicationName: [{}], Department name: [{}], Role name: [{}]", departmentName, departmentName, roleName);
    ...
    @Override
    public void deleteRole(String roleName, String departmentName) throws IAMException {
    ...
    @Override
    public void assignRoleToUser(String departmentCode, String roleName, String userId) throws IAMException {
